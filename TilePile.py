...
class TilePile():
    ...
    def populate_pile(self):
        ...
        #----- green -----
        for i in range(0, 3):
            self.pile.append(Tile(14, [(63,0)], [[2, 3],[2, 5],[2, 6],[3, 5],[3, 6],[5, 6]], [[50, 2, 3, 5, 6], [50, 2, 3, 5, 6]], 0, 1, "green"))    #14
        for i in range(0, 2):
            self.pile.append(Tile(15, [(63,0)], [[1, 2],[1, 3],[1, 6],[2, 3],[2, 6],[3, 6]], [[50, 1, 2, 3, 6], [50, 1, 2, 3, 6]], 0, 1, "green"))    #15
        ...
        self.pile.append(Tile(54, [(62,0)], [[1, 2],[5, 6]], [[7, 1, 2, 5, 6], [50, 1, 2, 5, 6]], 0, 4, "green"))    #54 NY
        for i in range(0, 2):
            self.pile.append(Tile(59, [(64,2), (65,2), (66,3), (67,0), (68,1), (68,4)], [[2,0],[4,0]], [[50, 4], [50, 2]], 0, 2, "green"))  #59 "OO"      
        ...
        self.pile.append(Tile(62, (), [[1, 2],[5, 6]], [[7,1,2], [50,1,2], [50,5,6], [50,5,6]], 0, 4, "brown"))    #62
        for i in range(0, 3):
        ...
        self.pile.append(Tile(64, (), [[1, 2],[4, 6]], [[50, 1, 2], [50, 4, 6]], 0, 2, "brown"))  #64
        self.pile.append(Tile(65, (), [[2, 3],[4, 6]], [[50, 2, 3], [50, 4, 6]], 0, 2, "brown"))  #65
        self.pile.append(Tile(66, (), [[1, 6],[2, 5]], [[50, 1, 6], [50, 2, 5]], 0, 2, "brown"))  #66
        self.pile.append(Tile(67, (), [[2, 5],[4, 6]], [[50, 4, 6], [50, 2, 5]], 0, 2, "brown"))  #67
        self.pile.append(Tile(68, (), [[1, 4],[3, 6]], [[50, 3, 6], [50, 1, 4]], 0, 2, "brown"))  #68
        ...
        self.pile.append(Tile(81, [(53,0)], [[2,4]], [[2, 2, 4]], 0, 1, "special") )    # Boston
        self.pile.append(Tile(82, [(54,5)], [[1,0], [4,0]], [[7, 1], [50, 4]], 0, 2, "special"))   # New York
        for i in range(4):
            self.pile.append(Tile(83, [(59,0), (59,1), (59,2), (59,3), (59,4), (59,5)], [[]], [[50],[50]], 0, 2, "special"))   # blank "00"
