...
class TilePile():
    ...
    def populate_pile(self):
        ...
        for i in range(0, 4):
            self.pile.append(Tile(57, [(14,0), (14,1), (14,3), (14,4), (15,0), (15,3)], [(3, 6)], [(100, 0)], 0, 1))  #57
        for i in range(0, 2):
        ...
        #----- green -----
        for i in range(0, 3):
            self.pile.append(Tile(14, [(63,0)], [(2, 3),(2, 5),(2, 6),(3, 5),(3, 6),(5, 6)], ((100, 0, 1, 2, 3, 4, 5), (100, 0, 1, 2, 3, 4, 5)), 0, 2))    #14
        for i in range(0, 2):
            self.pile.append(Tile(15, [(63,0)], [(1, 2),(1, 3),(1, 6),(2, 3),(2, 6),(3, 6)], ((100, 0, 1, 2, 3, 4, 5), (100, 0, 1, 2, 3, 4, 5)), 0, 2))    #15
        ...
        for i in range(0, 2):
            self.pile.append(Tile(53, [(61,0), (61,1), (61,2), (61,3), (61,4), (61,5)], [(1, 3),(1, 5),(3, 5)], ((100, 0, 1, 2, 3, 4, 5)), 0, 1))    #53
        self.pile.append(Tile(54, [(62,0)], [(1, 2),(5, 6)], ((100, 0), (100, 1)), 0, 2))    #54
        for i in range(0, 2):
            self.pile.append(Tile(59, [(64,0), (64,2),
                                       (65,0), (65,2),
                                       (66,2), (66,3),
                                       (67,0), (67,2),
                                       (68,1), (68,4)], [(2,0),(4,0)], ((100, 0), (100, 1)), 0, 2))  #59 "OO"      
        ...
        for i in range(0, 2):
            self.pile.append(Tile(61, (), [(1, 3),(1, 5),(1, 6),(3, 5),(3, 6),(5, 6)], ((100, 0, 1, 2, 3, 4, 5)), 0, 1))  #61
        self.pile.append(Tile(62, (), [(1, 2),(5, 6)], ((100, 0), (100, 0), (100, 1), (100, 1)), 0, 4))    #62
        for i in range(0, 3):
            self.pile.append(Tile(63, (), [(1, 2),(1, 3),(1, 4),(1, 5),(1, 6),(2, 3),(2, 4),(2, 5),(2, 6),(3, 4),(3, 5),(3, 6),(4, 5),(4, 6),(5, 6)],((100, 0, 1, 2, 3, 4, 5), (100, 0, 1, 2, 3, 4, 5)), 0, 2))     #63
        self.pile.append(Tile(64, (), [(1, 2),(4, 6)], ((100, 0), (100, 1)), 0, 2))  #64
        self.pile.append(Tile(65, (), [(2, 3),(4, 6)], ((100, 0), (100, 1)), 0, 2))  #65
        self.pile.append(Tile(66, (), [(1, 6),(2, 5)], ((10, 0), (100, 1)), 0, 2))  #66
        self.pile.append(Tile(67, (), [(2, 5),(4, 6)], ((100, 0), (100, 1)), 0, 2))  #67
        self.pile.append(Tile(68, (), [(1, 4),(3, 6)], ((100, 0), (100, 1)), 0, 2))  #68
        self.pile.append(Tile(70, (), [(1, 3),(1, 6),(2, 3),(2, 6)], (), 0, 0))    #70
        
        #----- special tiles for cities and OO -----
        self.pile.append(Tile(80, [(53,1)], [(1,3)], [(0, 0)], 0, 1))     # Baltimore
        self.pile.append(Tile(81, [(53,0)], [(1,3)], [(1, 0)], 0, 1))     # Boston
        self.pile.append(Tile(82, [(54,5)], [(1,0), (4,0)], [(6, 0), (100, 1)], 0, 2))   # New York
        for i in range(4):
