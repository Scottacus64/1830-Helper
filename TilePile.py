...
class TilePile():
    ...
    def populate_pile(self):
        ...
        for i in range(0, 2):
            self.pile.append(Tile(53, [(61,0), (61,2), (61,4)], [(1, 3),(1, 5),(3, 5)], (("blank", 0, 1, 2)), 0, 1))    #53
        self.pile.append(Tile(54, [(62,0)], [(1, 2),(5, 6)], (("blank", 0), ("blank", 1)), 0, 2))    #54
        for i in range(0, 2):
            self.pile.append(Tile(59, [(64,0), (64,2) ,(65,0), (65,2), (66,2), (66,3), (67,0), (67,2), (68,1), (68,4)], [(2),(4)], (("blank", 0), ("blank", 1)), 0, 2))  #59, WEIRD CASE for "OO"      
        ...
        self.pile.append(Tile(82, [(54,1)], [(1,0), (4,0)], [("NNH", 0), ("blank", 1)], 0, 2))   # New York
